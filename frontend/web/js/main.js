...
$('#resume_sigma_show_more_btn').on('click', function () {
    $('#resume_sigma_details').show("fast");
    $('#resume_sigma_show_more_btn').hide("fast");
});

$('#resume_sigma_show_less_btn').on('click', function () {
    $('#resume_sigma_show_more_btn').show("fast");
    $('#resume_sigma_details').hide("fast");
});